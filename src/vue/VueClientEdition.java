...
public class VueClientEdition extends JPanel implements ActionListener {

	private JLabel lbTitre	= new JLabel("Liste des clients\n");
	private JTable tableClients;
	
	public VueClientEdition() {
	...
	public Object [][] extraireClients()
	{
		...
		Object [][]donnees	= new Object[lesClients.size()][3];
		int i=0;
